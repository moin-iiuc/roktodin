            ...
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <class class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <input type="text" name="nid" id="nid" autocomplete="given-name"
...
<p>{{$message}}</p>
                    ...
                    <div class="sm:col-span-3">
                        <label for="country" class="block text-sm font-medium leading-6 text-gray-900">Blood
                            Group</label>
                        <div class="mt-2">
                            <select id="bg" name="bg" autocomplete="country-name"
...
<p>{{$message}}</p>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <input type="text" name="thana" id="thana" autocomplete="given-name"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" required>
                        </div>
                        @error('thana')
<p>{{$message}}</p>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <input type="date" name="bg_given" id="bg_given" autocomplete="given-name"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" required>
                        </div>
                        @error('bg_given')
<p>{{$message}}</p>
...
<p>{{$message}}</p>
                ...
                <div class="mt-6 flex items-center justify-end gap-x-6">
                    ...
                    <button type="submit"
                        class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign Up</button>
                </div>
